...
model_pre = CAPSIF2_RES2(hidden_nf = HIDDEN_NF, n_layers=N_LAYERS,attention=True, 
...
dnn_to_bnn(model_pre,const_bnn_prior_parameters)
...
my_model_name = model_pre.get_string_name() + "_knn" + str(KNN[0]) + '-' + str(KNN[1]) + 'elbo_loss_2' 
...
print(model_pre.graph_module)
#print(model_pre)
#print(model_pre.graph_module)
#print(model_pre.graph_module.state_dict())
