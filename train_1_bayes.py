...
LOSS_FN = elbo_loss#some bayes loss
KNN = [10,20,40,60]
N_LAYERS = [3,3,3,3]
HIDDEN_NF = 128
PAD_SIZE = 2500
...
model = CAPSIF2_RES2(hidden_nf = HIDDEN_NF, n_layers=N_LAYERS,normalize=NORMALIZE, attention=True,
...
my_model_name = model.get_string_name() + "_knn" + str(KNN[0]) + '-' + str(KNN[1])+LOSS_FN.__name__
