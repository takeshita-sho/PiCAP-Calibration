...
class CAPSIF2_RES(nn.Module):
    def __init__(self, in_node_nf=1280, hidden_nf=128, out_node_nf=128, in_edge_nf=23,
        ...
        super(CAPSIF2_RES, self).__init__()
        self.hidden_nf = hidden_nf
        self.device = device
        self.n_layers = n_layers
    ...
    def forward(self, h, x, edges, edge_attr,is_batch=False,n_res=100,n_edge=100):
        ...
        h_0 = h_prime
        x_prime = x
        h_preim = torch.nan_to_num(h_prime, nan=0.0)
    ...
    def get_string_name(self):
        name = "CAPSIF2_RES_" + str(self.hidden_nf) + "_nlayer-" + str(self.n_layers[0])
...
class CAPSIF2_PROT(nn.Module):
    def __init__(self, in_node_nf=1280, hidden_nf=128, out_node_nf=128, in_edge_nf=23,
            output_dim=1, adapool_size=(150,128),
            device='cpu', act_fn=nn.ReLU(), n_layers=[4,4,4,4],
            residual=True, attention=True, normalize=True, tanh=False):
            #residual=True, attention=True, normalize=False, tanh=False):
        '''
        ...
        super(CAPSIF2_PROT, self).__init__()
        self.hidden_nf = hidden_nf
        self.device = device
        self.n_layers = n_layers
        self.out_node_nf = out_node_nf
